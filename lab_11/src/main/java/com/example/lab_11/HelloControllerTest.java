...
class HelloControllerTest { //NOPMD - suppressed AtLeastOneConstructor - not needed
    ...
    @Test
    void loadNew() { //NOPMD - suppressed CommentDefaultAccessModifier
    }
    ...
    @Test
    void initialize() { //NOPMD - suppressed CommentDefaultAccessModifier
    }

    @Test
    void getAction() { //NOPMD - suppressed CommentDefaultAccessModifier
    }

    @Test
    void getFormat() { //NOPMD - suppressed CommentDefaultAccessModifier
    }
